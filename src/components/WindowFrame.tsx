...
interface WindowFrameProps {
  ...
  onClose?: () => void
  onMaximize?: () => void
  // Skips the macOS traffic-light bar entirely, for callers that build their
  // own title bar (e.g. PacmanModal's title + explicit close button).
  hideDots?: boolean
}

export default function WindowFrame({ children, className, onClose, onMaximize, hideDots }: WindowFrameProps) {
  return (
